...
def video_tracker(video_path, student, concept, sections=None):
    ...
    Progress events are sent once every second while the video
    is actually playing.
    """
...
function getCurrentSection(position) {{
    ...
    if (
        ...
        const sectionLength =
            video.duration / sections.length;
